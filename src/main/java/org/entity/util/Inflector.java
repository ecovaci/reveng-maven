...
public class Inflector {
     ...
     *
     * @param lowerCaseAndUnderscoredWord the word that is to be converted to camel case
     * @param uppercaseFirstLetter        true if the first character is to be uppercased, or false if the first character is to
     *                                    be lowercased
     * @param delimiterChars              optional characters that are used to delimit word boundaries
    ...
    public void addIrregular(String singular, String plural) {
        Validate.isTrue(!StringUtils.isEmpty(singular), "singular rule");
        Validate.isTrue(!StringUtils.isEmpty(plural), "plural rule");
